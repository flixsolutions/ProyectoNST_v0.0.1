...
var Menu = React.createClass({
    ...
    render(){
      ...
      return (
        <div id="menu">
          <div className="w3-row  w3-white w3-card-4  w3-text-grey  ">
            ...
            <div className="w3-container">
              ...
              <p><i className="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal "></i>Impulso</p>
              <p className="w3-hide-medium"><i className="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal "></i>susana.gaytan@oxxo.com</p>
              <p className="w3-hide-medium"><i className="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal "></i>81-83892121 Ext.2335</p>
              <hr/>
            </div>
